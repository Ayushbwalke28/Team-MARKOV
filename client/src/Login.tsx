    ...
    <div className="min-h-screen flex font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-[#f7f9fb] px-6">
        <div className="w-full max-w-md">
          ...
          {/* Google Auth */}
          <a href={`${import.meta.env.VITE_API_URL || 'http://localhost:3001/api'}/auth/google`} className="w-full flex items-center justify-center gap-3 bg-white hover:bg-[#f2f4f6] border border-[#e0e3e5] py-3 rounded-xl text-sm font-medium text-[#191c1e] mb-6 transition-colors shadow-sm">
